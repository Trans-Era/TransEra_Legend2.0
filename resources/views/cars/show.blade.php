<x-minimal-layout>
    @section('meta_title', $car->name)
    @section('meta_description', 'Location de' . $car->name $car->name . ' à petit prix disponible sous peu à Metz, Strasbourg, Thionville, Nancy et au Luxembourg')
