<section class="w-full py-12 px-4 bg-white dark:bg-muted-900 overflow-hidden">
          <div class="w-full max-w-7xl mx-auto">
            ...
            <div class="aspect-w-16 aspect-h-9">
              <!--<iframe src="https://www.youtube.com/embed/7BDlGqj2SWE?si=fKkJgPiKp3UrD1Y3" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>-->
              </div>
          </div>
        </section>