  ...
  >
    <div class="w-full max-w-7xl mx-auto flex flex-col md:flex-row md:items-center py-2 px-4">
      <div class="flex items-center gap-2 text-muted-500 dark:text-white">
        <div class="h-12 w-12"><?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.vector.logos.mercedes','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('vector.logos.mercedes'); ?>
...
<?php /**PATH C:\laragon\www\TransEra_website\resources\views/components/navbar/vehicle.blade.php ENDPATH**/ ?>