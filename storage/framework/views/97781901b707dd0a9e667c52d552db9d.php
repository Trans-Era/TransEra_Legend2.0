  ...
  <div class="w-full max-w-7xl mx-auto">
    ...
    <div x-data="{ videoPlaying: false }" class="relative w-full">
      <video id="myVideo" x-ref="video" class="w-full h-auto" controls>
        <source src="<?php echo e(asset('video/mustang.mp4')); ?>" type="video/mp4">
...
</section><?php /**PATH C:\laragon\www\TransEra_website\resources\views/components/section/car/video.blade.php ENDPATH**/ ?>