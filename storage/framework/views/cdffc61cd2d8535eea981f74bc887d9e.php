<nav class="fixed w-full z-50 transition-all duration-300 ease-in-out flex flex-col flex-shrink-0 divide-y divide-white/10" x-data="navbar()" x-init="initTheme()" x-on:scroll.window="scroll()" x-on:mouseleave="megamenuOpened = false, openedMegamenu = ''" x-bind:class="{
      ...
      <div class="w-full">
        <div class="
          ...
          <div class="flex justify-between items-center w-full lg:w-1/5">
            <a href="<?php echo e(url('/')); ?>" class="group flex font-sans font-light items-center gap-4 text-white">
              <div class="
                  h-14
                  w-14
                  ...
                  <div class="
                    ...
                    <div class="
                      ...
                      <a href="/inventory.html" class="
                        ...
                        ">
                        <div class="w-full max-w-[60px] my-2 text-muted-500">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80.271 30.626" class="w-full fill-current">
                      ...
                      <a href="/inventory.html" class="
                        ...
                        ">
                        <div class="w-full max-w-[60px] my-2 text-muted-500">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 77.8 27" class="w-full fill-current">
                            <path d="M13.438 15.684a5.64 5.64 0 00-5.658 5.658A5.64 5.64 0 0013.438 27a5.64 5.64 0 005.658-5.658c-.088-3.094-2.563-5.658-5.658-5.658zm0 9.371c-2.033 0-3.713-1.68-3.713-3.713s1.68-3.713 3.713-3.713c2.033 0 3.713 1.68 3.713 3.713s-1.591 3.713-3.713 3.713z"></path>
                      ...
                      <a href="/inventory.html" class="
                        ...
                        ">
                        <div class="w-full max-w-[60px] my-2 text-muted-500">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 82 25.9" class="w-full fill-current">
                            <path d="M80.869 13.345l-.653-5.597s-3.078-3.265-6.064-5.504l.653-.28-.187-.466C55.774.005 40.662-.648 34.784.845c-.933.28-3.452 1.679-11.381 6.903 0 0-13.713.84-18.658 2.799l-2.052.84-2.146 3.078.187 2.146-.746.746s.373 4.011.373 3.918l5.784 1.026h.187c-.187-.653-.373-1.399-.373-2.052 0-3.732 2.985-6.717 6.717-6.717s6.717 2.985 6.717 6.717c0 .746-.093 1.493-.373 2.146h38.715c-.187-.653-.373-1.399-.373-2.146a6.689 6.689 0 016.717-6.717 6.689 6.689 0 016.717 6.717c0 .466 0 .84-.093 1.306h.28l9.142-1.119 1.493-2.519.373-3.452c.09-.093-.376-.56-1.122-1.12zM5.026 14.652l-3.079 1.213s.653-2.146 2.052-2.985c.84-.466 3.545-1.119 3.545-1.119l-2.518 2.891zM65.57 8.868c-17.165.373-28.92.746-40.674 1.679-3.732.28-12.127.746-13.433 1.026.84-.28 5.224-1.493 12.967-1.959 5.038-3.825 9.702-6.717 11.101-7.09s5.038-.746 9.329-.746l-.653 6.717c.933 0 1.772-.093 2.705-.093l.653-6.53c2.985-.187 12.407.373 12.407.373l2.239 5.784h1.866l-2.239-5.597c2.425.187 5.784.56 8.489 1.493C74.245 5.324 76.95 8.31 76.95 8.31s-3.638.371-11.38.558z"></path>
                            <path d="M64.17 14.838c-2.985 0-5.504 2.425-5.504 5.504 0 2.985 2.425 5.504 5.504 5.504 2.985 0 5.504-2.425 5.504-5.504-.093-3.078-2.519-5.504-5.504-5.504zm0 8.956a3.444 3.444 0 01-3.452-3.452 3.444 3.444 0 013.452-3.452c1.959 0 3.452 1.586 3.452 3.452s-1.586 3.452-3.452 3.452z"></path>
                            <circle cx="64.17" cy="20.342" r="2.519"></circle>
                            <path d="M12.769 14.838c-2.985 0-5.504 2.425-5.504 5.504 0 2.985 2.425 5.504 5.504 5.504 2.985 0 5.504-2.425 5.504-5.504-.094-3.078-2.519-5.504-5.504-5.504zm0 8.956a3.444 3.444 0 01-3.452-3.452 3.444 3.444 0 013.452-3.452c1.959 0 3.452 1.586 3.452 3.452s-1.587 3.452-3.452 3.452z"></path>
                            <circle cx="12.769" cy="20.342" r="2.519"></circle>
                          </svg>
                        </div>
                        <div>
                          <h4 class="
                      ...
                      <a href="/inventory.html" class="
                        ...
                        ">
                        <div class="w-full max-w-[60px] my-2 text-muted-500">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 86.4 32.8" class="w-full fill-current">
              ...
              <li class="relative" x-on:mouseover="megamenuOpened = true, openedMegamenu = 'megamenu-2'">
                ...
                <div class="fixed lg:absolute top-0 lg:top-14 inset-x-0 lg:left-0 w-full lg:w-[540px] h-screen lg:h-auto pt-2 lg:-translate-x-1/4 transition-all duration-300 opacity-0 translate-y-1 pointer-events-none z-0" x-bind:class="{
                  ...
                  <path class="fill-current" clip-rule="evenodd" fill-rule="evenodd" d="M126.1,0C56.5,0,0,56.5,0,126.1c0,69.7,56.5,126.1,126.1,126.1c69.7,0,126.1-56.5,126.1-126.1
                	...
                	L143.4,116.7L143.4,116.7L127.8,7.2c41.9,0.6,80.4,23.2,101.4,59.5c21.1,36.3,21.6,80.8,1.3,117.5L143.4,116.7z"></path>
                </svg>
                </div>
                        <div>
                          <h4 class="
          ...
          <div class="
            ...
            <button type="button" class="
              ...
              <div class="
                  ...
                  duration-300
                ">
                <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" viewBox="0 0 24 24" data-icon="lucide:search" class="iconify w-4 h-4 iconify--lucide"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="11" cy="11" r="8"></circle><path d="m21 21l-4.35-4.35"></path></g></svg>
              </div>
            </button>
            ...
            <?php else: ?>
                <a href="<?php echo e(route('login.index')); ?>" class="
                  relative
                  font-sans font-normal
                  inline-flex
                  items-center
    ...
    </nav><?php /**PATH C:\laragon\www\TransEra_website\resources\views/components/navbar/static.blade.php ENDPATH**/ ?>