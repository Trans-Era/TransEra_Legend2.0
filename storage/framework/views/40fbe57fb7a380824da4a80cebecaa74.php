    ...
    <div class="min-h-screen bg-white dark:bg-muted-800 flex">
      <div
        class="
          ...
          dark:bg-muted-1000
        "
        data-background="<?php echo e(asset('img/login/city.webp')); ?>"
      ></div>
      <div
        class="
          relative
...
<?php endif; ?><?php /**PATH C:\laragon\www\TransEra_website\resources\views/auth/login/index.blade.php ENDPATH**/ ?>