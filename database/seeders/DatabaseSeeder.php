...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $modeles = ['Mustang 5.0', 'Corvette C7', 'Firebird GTA'];
        ...
        $types = [
            ['name' =>'Muscle Car', 'description' =>'Voiture de sport d origine USA'],
            ['name' =>'Exotic Car', 'description' =>'Coupé élégant de haut standing'],
            ['name' =>'Old Car', 'description' =>'Voiture ancienne de renommée']
        ];
        ...
        foreach ($descriptions as $descriptionData) {
            Description::factory()->create(array_merge($descriptionData));
        }

        // Création des photos pour chaque voiture
        $photos = [
            [
                'name' =>'lateral',
